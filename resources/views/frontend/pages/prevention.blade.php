        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="index.html">
                    <img src="{{asset('frontend/assets/images/logo.png')}}" srcset="{{asset('frontend/assets/images/logo.png')}}" alt="" width="200" />
                    <img src="{{asset('frontend/assets/images/logo.png')}}" srcset="{{asset('frontend/assets/images/logo.png')}}" alt="" width="200" />
                </a>
...
<section class="prevention_banner">
    <div class="container">
        <div class="prevention_text">
            ...
            <h3 class="wow fadeInUp" data-wow-delay="0.2s">How to prevent COVID-19?</h3>
            <ul class="nav justify-content-center wow fadeInUp" data-wow-delay="0.3s">
                <li><a href="index.html">Home</a></li>
                <li><a href="prevention.html">Prevention</a></li>
                <li><a href="#">How to prevent COVID-19?</a></li>
            </ul>
            <img class="img-fluid" src="{{asset('frontend/assets/images/breadcrumb/prevention-persong.png')}}" alt="" >
        </div>
    </div>
</section>
        ...
        <div class="row protect_inner flex-row-reverse">
            ...
            <div class="col-lg-6">
                <div class="protect_img">
                    <img class="img-fluid" src="{{asset('frontend/assets/images/protect-img-2.png')}}" alt="" width="400" />
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="prevent_item_inner row">
                    <div class="col-sm-6">
                        <div class="prevent_item wow fadeInUp">
                            <div class="prevent_img">
                                <img class="img-fluid" src="{{asset('frontend/assets/images/prevent/prevent-1.png')}}" alt="" />
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="prevent_item wow fadeInUp" data-wow-delay="0.2s">
                            <div class="prevent_img">
                                <img class="img-fluid" src="{{asset('frontend/assets/images/prevent/prevent-2.png')}}" alt="" />
                            </div>
                            <div class="prevent_text">
                    ...
                    <div class="col-sm-6">
                        <div class="prevent_item wow fadeInUp" data-wow-delay="0.4s">
                            <div class="prevent_img">
                                <img class="img-fluid" src="{{asset('frontend/assets/images/prevent/prevent-3.png')}}" alt="" />
                            </div>
                            <div class="prevent_text">
                    ...
                    <div class="col-sm-6">
                        <div class="prevent_item wow fadeInUp" data-wow-delay="0.6s">
                            <div class="prevent_img">
                                <img class="img-fluid" src="{{asset('frontend/assets/images/prevent/prevent-4.png')}}" alt="" />
                            </div>
                            <div class="prevent_text">
                                <h4>Wear Facemask</h4>
                                <p>

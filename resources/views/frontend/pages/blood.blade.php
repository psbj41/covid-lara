...
<section class="breadcrumb_area boi_breadcrumb">
    <div class="container">
        <div class="breadcrumb_text">
            <h3 class="wow fadeInUp" data-wow-delay="0.2s">Blood Donation Form</h3>
            <ul class="nav justify-content-center wow fadeInUp" data-wow-delay="0.3s">
                <li><a href="index.html">Home</a></li>
                <li><a href="doctors.html">Blood Donation Form</a></li>
            </ul>
        </div>
        <div class="row appointment_box">
            <div class="col-lg-4 appoinment_features">
                ...
                <h2>Donate Blood</h2>
                <p>
                    Fill out the form to donate blood and our staff
                    will contact you immediately.
                </p>
            </div>
            <div class="col-lg-8">
                <form action="{{route('blood.store2')}}" method="POST" class="appoinment_form">
                    @csrf
                    @if (session('success'))
                    <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <select class="form-control" type="text" id="a_number" name="gender" placeholder="" >
                                <option value="">Select Gender</option>
                                <option value="male">male</option>
                                <option value="female">female</option>
                                </select>
                                {{-- <label><i class="linearicons-telephone"></i>Gender</label> --}}
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                <input class="form-control" type="text" id="a_number" name="age" placeholder="" />
                                <label><i class="linearicons-telephone"></i>Age</label>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                <input class="form-control" type="text" id="subject" name="btype" placeholder="" />
                                <label><i class="linearicons-document"></i>Blood type (O positive)</label>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                <input class="form-control" type="text" id="subject" name="anyd" placeholder="" />
                                <label><i class="linearicons-document"></i>DO you have any Disease</label>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                <textarea name="address" id="a_message" cols="30" rows="10"
                                    class="form-control"></textarea>
                                <label><i class="linearicons-pencil4"></i>Your Address</label>
                            </div>
                        </div>
                        <div class="col-lg-12">
            ...
            <div class="col-lg-6">
                <div class="work_content">
                    ...
                    <ol class="work_list">
                        ...
                        <li class="wow fadeInUp" data-wow-delay="0.4s">Add your health issue
                        </li>
                    </ol>
                </div>
            </div>

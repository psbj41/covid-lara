                                    ...
                                    <div class="row clearfix">
                                        <div class="col-md-6 col-sm-6">
                                            <div class="form-group c_form_group">
                                                ...
                                                <input class="form-control" type="email" value="" name="email" placeholder="Enter here">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                            <div class="form-group c_form_group">
                                                <label>Password<span class="text-danger">*</span></label>
                                                <input class="form-control" type="password" value="" placeholder="Enter here" name="password">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row clearfix">
